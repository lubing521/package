...
EXPORT_SYMBOL(ath79_mbox_dma_prepare);
...
EXPORT_SYMBOL(ath79_mbox_dma_map);
...
EXPORT_SYMBOL(ath79_mbox_dma_unmap);
...
EXPORT_SYMBOL(ath79_mbox_dma_init);
...
EXPORT_SYMBOL(ath79_mbox_dma_exit);

MODULE_AUTHOR("djy@guogee");
